...
public:
   ...
   * DBUS_MESSAGE_HEADER_FIELD_INVALID.  Each element is a
   * #guchar. Free with Glib::free().
   */
   ...
   * @param capabilities A DBusCapabilityFlags describing what protocol features are supported.
   * @return A pointer to a valid binary D-Bus message of @a out_size bytes
   * generated by @a message or <tt>0</tt> if @a error is set. Free with Glib::free().
   */

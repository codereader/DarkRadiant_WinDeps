...
GTKSOURCEVIEW_DLL_EXPORT GType gtk_source_search_flags_get_type (void);
G_END_DECLS

#include <gtksourceview/gtksourceview.h>
G_BEGIN_DECLS
#define GTK_TYPE_SOURCE_SMART_HOME_END_TYPE gtk_source_smart_home_end_type_get_type()
GTKSOURCEVIEW_DLL_EXPORT GType gtk_source_smart_home_end_type_get_type (void);
G_END_DECLS

G_BEGIN_DECLS
#define GTK_TYPE_SOURCE_DRAW_SPACES_FLAGS gtk_source_draw_spaces_flags_get_type()
GTKSOURCEVIEW_DLL_EXPORT GType gtk_source_draw_spaces_flags_get_type (void);
G_END_DECLS

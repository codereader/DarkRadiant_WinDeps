...
Glib::SignalProxy1< void,const Glib::RefPtr<Drive>& > VolumeMonitor::signal_drive_stop_button()
{
  return Glib::SignalProxy1< void,const Glib::RefPtr<Drive>& >(this, &VolumeMonitor_signal_drive_stop_button_info);
}

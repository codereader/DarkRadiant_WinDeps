...
void ColorSelection::set_current_rgba(const Gdk::RGBA& color)
{
  gtk_color_selection_set_current_rgba(gobj(), (color).gobj()); 
}

void ColorSelection::set_previous_rgba(const Gdk::RGBA& color)
{
  gtk_color_selection_set_previous_rgba(gobj(), (color).gobj()); 
}

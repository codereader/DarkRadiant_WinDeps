...
:
  ...
  Glib::ObjectBase(0),
  Gtk::Button(Glib::ConstructParams(scalebutton_class_.init(), "size", static_cast<GtkIconSize>(int(size)), "min", min, "max", max, "step", step, "icons", Glib::ArrayHandler<Glib::ustring>::vector_to_array(icons).data (), static_cast<char*>(0)))
{

...
{
  gtk_widget_queue_draw_region(gobj(), ((region) ? (region)->cobj() : 0)); 
}
...
{
  return ::Cairo::RefPtr< ::Cairo::Region>(new ::Cairo::Region(gtk_widget_region_intersect(const_cast<GtkWidget*>(gobj()), ((region) ? (region)->cobj() : 0)), true /* do not take ref */));
}
...
{
  gtk_widget_shape_combine_region(gobj(), const_cast<cairo_region_t*>((region) ? (region)->cobj() : 0)); 
}

void Widget::input_shape_combine_region(const ::Cairo::RefPtr<const ::Cairo::Region>& region)
{
  gtk_widget_input_shape_combine_region(gobj(), const_cast<cairo_region_t*>((region) ? (region)->cobj() : 0)); 
}

...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(0),
  Gtk::Button(Glib::ConstructParams(colorbutton_class_.init(), "rgba", (rgba).gobj(), static_cast<char*>(0)))
{
...
void ColorButton::set_rgba(const Gdk::RGBA& color)
{
  gtk_color_button_set_rgba(gobj(), (color).gobj()); 
}

...
public:
   ...
   * 
   * @newin{2,26}
   * @param res A AsyncResult obtained from the AsyncReadyCallback passed to g_dbus_connection_new().
   * @return A DBusConnection or <tt>0</tt> if @a error is set. Free with Glib::object_unref().
   */
   ...
   * 
   * @newin{2,26}
   * @param res A AsyncResult obtained from the AsyncReadyCallback passed to g_dbus_connection_send_message_with_reply().

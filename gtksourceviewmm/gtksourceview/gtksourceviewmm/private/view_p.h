...
#ifndef _GTKSOURCEVIEWMM_VIEW_P_H
#define _GTKSOURCEVIEWMM_VIEW_P_H
...
class View_Class : public Glib::Class
{
public:
...
protected:
  ...
  static void line_mark_activated_callback(GtkSourceView* self, GtkTextIter* p0, GdkEvent* p1);
...
#endif /* _GTKSOURCEVIEWMM_VIEW_P_H */

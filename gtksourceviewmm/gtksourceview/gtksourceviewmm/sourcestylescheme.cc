...
{
  return Glib::RefPtr<gtksourceview::SourceStyleScheme>( dynamic_cast<gtksourceview::SourceStyleScheme*> (Glib::wrap_auto_interface<gtksourceview::SourceStyleScheme> ((GObject*)(object), take_copy)) );
...
SourceStyleScheme::SourceStyleScheme(const Glib::Interface_Class& interface_class)
...
Glib::StringArrayHandle SourceStyleScheme::get_authors() const
{
  return Glib::StringArrayHandle(gtk_source_style_scheme_get_authors(const_cast<GtkSourceStyleScheme*>(gobj())));
}

std::string SourceStyleScheme::get_filename() const
{
...
Glib::RefPtr<SourceStyle> SourceStyleScheme::get_style(const Glib::ustring& style_id)
{

  Glib::RefPtr<SourceStyle> retvalue = Glib::wrap(gtk_source_style_scheme_get_style(gobj(), style_id.c_str()));
  if(retvalue)
...
Glib::RefPtr<const SourceStyle> SourceStyleScheme::get_style(const Glib::ustring& style_id) const
{
  return const_cast<SourceStyleScheme*>(this)->get_style(style_id);
}

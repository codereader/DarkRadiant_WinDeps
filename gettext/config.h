...
#include <stdint.h> // greebo: Use this instead of the 2 lines below
//#define uintmax_t unsigned __int64 // greebo: commented out, leads to error
//#define intmax_t __int64			 // greebo: commented out, leads to error
